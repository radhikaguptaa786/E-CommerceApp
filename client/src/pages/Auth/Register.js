  ...
  return (
    ...
    <div className='form-container'>
        ...
        <div className="mb-3">
            ...
            className="form-control" id="Name"  placeholder='Eg.- ABC' maxLength={50} required/>
        </div>
        <div className="mb-3">
            ...
            onChange={(event)=>
             ...
             className="form-control" id="Email" placeholder='abc@gmail.com' required/>
        ...
        <div className="mb-3">
            ...
            className="form-control" id="Phone" placeholder='000000000' maxLength={10} minLength={10} required/>
        </div>
        <div className="mb-3">
